...
function v0_v2(v0) {
  ...
  const {
    ...
    _version: 2,
    avatar: __spreadValues$6(__spreadValues$6({}, defaultThemeConfig.avatar), avatar),
    button: __spreadValues$6(__spreadValues$6({}, defaultThemeConfig.button), button),
    ...
    container,
    font,
    input: __spreadProps$6(__spreadValues$6(__spreadValues$6({}, defaultThemeConfig.input), input), {
      checkbox: __spreadValues$6(__spreadValues$6({}, defaultThemeConfig.input.checkbox), input.checkbox),
      radio: __spreadValues$6(__spreadValues$6({}, defaultThemeConfig.input.radio), input.radio),
      switch: __spreadValues$6(__spreadValues$6({}, defaultThemeConfig.input.switch), input.switch)
    }),
