import {
  ...
  usePaneLayout,
  useStructureTool
} from "./chunk-XLJA75RV.js";
import "./chunk-UKWNV7HB.js";
import {
  Button,
  ErrorBoundary,
  NEVER,
...
var paneMap = {
  component: (0, import_react.lazy)(() => import("./_chunks-es-OLPFXBKV.js")),
  document: (0, import_react.lazy)(() => import("./pane-GPS24FBC.js").then(function(n) {
    return n.pane;
  })),
  documentList: (0, import_react.lazy)(() => import("./pane-GPS24FBC.js").then(function(n) {
    return n.pane$1;
  })),
  list: (0, import_react.lazy)(() => import("./index2-BJWNEKIX.js"))
};
...
//# sourceMappingURL=index3-PPRMP5IS.js.map
