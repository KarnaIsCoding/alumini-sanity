...
var structureUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources4-YYAAGDPO.js")
});
...
function PaneLayout(props) {
  ...
  const controller = t0, [rootElement, setRootElement] = (0, import_react.useState)(null), rootRect = useElementRect(rootElement), width = (rootRect == null ? void 0 : rootRect.width) || 0, collapsed = width === void 0 || !minWidth ? void 0 : width < minWidth;
  let t2;
  ...
  let t16;
  $[26] !== children || $[27] !== restProps || $[28] !== t13 || $[29] !== t14 || $[30] !== t15 ? (t16 = (0, import_jsx_runtime.jsx)(Root$5, __spreadProps$B(__spreadValues$H({ "data-ui": "PaneLayout" }, restProps), { "data-collapsed": t13, "data-resizing": t14, "data-mounted": t15, ref: setRootElement, children })), $[26] = children, $[27] = restProps, $[28] = t13, $[29] = t14, $[30] = t15, $[31] = t16) : t16 = $[31];
  let t17;
  ...
  return schemaType ? (0, import_jsx_runtime.jsxs)(GetFormValueProvider, { value, children: [
    ...
    (0, import_jsx_runtime.jsx)(FieldActionsProvider, { actions: rootFieldActionNodes, path: EMPTY_ARRAY, children: (0, import_jsx_runtime.jsxs)(DocumentActionShortcuts, { actionsBoxElement, as: Pane, currentMinWidth, "data-testid": "document-pane", flex: 2.5, id: paneKey, minWidth, onKeyUp: handleKeyUp, rootRef: setRootElement, children: [
      ...
      (0, import_jsx_runtime.jsx)(PortalProvider, { __unstable_elements: {
        ...
        StartInCreateBanner && (0, import_jsx_runtime.jsx)(ShowWhenPaneOpen, { children: (0, import_jsx_runtime.jsx)(StartInCreateBanner, { document: value, documentId, documentType: schemaType, isInitialValueLoading: !!isInitialValueLoading, panelPortalElementId: DOCUMENT_PANEL_PORTAL_ELEMENT }) }),
...
var structureTool = definePlugin((options) => {
  ...
  return {
    ...
    tools: [{
      ...
      icon,
      component: (0, import_react.lazy)(() => import("./index3-PPRMP5IS.js")),
...
@tanstack/react-table/build/lib/index.mjs:
  (**
     ...
     *)
*/
//# sourceMappingURL=chunk-XLJA75RV.js.map
