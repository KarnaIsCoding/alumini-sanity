...
export declare function handleNavigation(location: Location, routes: RouteObject[], navigationType: Action, version: V6CompatibleVersion, matches?: AgnosticDataRouteMatch, basename?: string): void;
